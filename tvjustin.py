...
# --- Tüm Kanal Listesini Kazıma Fonksiyonu (GÜNCELLENDİ: 'networkidle' yerine 'wait_for_selector' kullanıldı) ---
def scrape_all_channels(page):
    ...
    try:
        ...
        print(f"-> Ana sayfaya ({JUSTINTV_DOMAIN}) gidiliyor...")
        # 'networkidle' yerine 'domcontentloaded' kullanıyoruz (daha hızlı).
        page.goto(JUSTINTV_DOMAIN, timeout=45000, wait_until='domcontentloaded')
        print("-> Sayfa DOM'u yüklendi.")

        # Kritik değişiklik: 'networkidle' veya kör 'timeout' beklemek yerine,
        ...
        # 'wait_for_selector' başarılı olduysa elementlerin var olduğunu biliyoruz,
        # 'elements_exist' kontrolüne gerek yok.
        ...
        # Hatanın 'wait_for_selector' kaynaklı olup olmadığını kontrol et
